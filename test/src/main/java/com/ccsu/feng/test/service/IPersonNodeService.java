...
public interface IPersonNodeService {
     ...
     */
    PersonVO addPersonNodeByName(String name);
     ...
     */
    PersonVO getPersonNodeByName(String name);
     ...
     * @description 添加武器
     */
    List<BaseRelationship> addPersonNodeWeapon(String name, String startName, String endName);
     ...
     * @return
     */
    PageResult<PersonVO> getListPersonNodeByPage(int pageIndex, int pageSize);
    ...
    PageResult<PersonVO> getListPersonNodeByPageAndName(String name, int pageIndex, int pageSize);
