...
public interface IPlaceNodeService {
     ...
     * @return
     */
    PageResult<PlaceVO> getListPlaceNodeByPage(int pageIndex, int pageSize);
    ...
    PageResult<PlaceVO> getListPlaceNodeByPageAndName(String name, int pageIndex, int pageSize);
}
