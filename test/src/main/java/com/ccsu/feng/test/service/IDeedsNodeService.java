...
public interface IDeedsNodeService {
     ...
     * @return
     */
    PageResult<DeedsVO> getListDeedsNodeByPage(int pageIndex, int pageSize);
    ...
    PageResult<DeedsVO> getListDeedsNodeByPageAndName(String name, int pageIndex, int pageSize);
}
